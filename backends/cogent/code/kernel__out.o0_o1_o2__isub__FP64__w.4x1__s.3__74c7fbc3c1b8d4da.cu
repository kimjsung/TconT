...
#define plane_v2 			(TILE_B1 * TILE_D)
...
int shm_v2_offset, int shm_t2_offset, int iter_d)
{
	for(int idx = (threadIdx.x << 1); idx < v2_elements; idx += (blockDim.x << 1))
	{
		...
		int v2_b1 = rem_v2 / TILE_D;
		int v2_d = rem_v2 - v2_b1 * TILE_D;

		int sm_src_v2 = v2_d + iter_d + (blk_idx_b * TILE_B + v2_b2 * TILE_B1 + v2_b1) * size_d;

		int sm_dst_v2 = shm_v2_offset + (v2_b2 * (TILE_B1 * TILE_D)) + (v2_d ^ (((v2_b1 >> 1) & 1) << 2)) + (v2_b1 << 3);
...
{
	const int ld_stride_a = TILE_B1 * TILE_D;
...
int size_internal, int v2_tile_size, int t2_tile_size)
{
	...
	// Tensor Contraction : [[16, 'STR_SD2_T2_H7', 'x', 't2', ['a', 'd', 'c']], [16, 'STR_SD2_V2_H7', '', 'v2', ['d', 'b']], '-']
